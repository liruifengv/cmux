...
@Test func terminalScrollRoutingForwardsAlternateScreenDeltasUnchanged() {
...
@Test func terminalScrollRoutingKeepsPrimaryScreenDeltasLocal() {
    var prefetchState = TerminalScrollbackPrefetchState(windowRows: 600, refreshDistanceRows: 10)

    let primed = TerminalScrollRouting.delivery(
        surfaceID: "surface",
    ...
    let followUp = TerminalScrollRouting.delivery(
        surfaceID: "surface",
        activeScreen: .primary,
        lines: 3,
        col: 1,
